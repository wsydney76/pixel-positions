<x-layout>
    ...
    <x-panel>
        ...
        <div class="mb-2 text-gray-600">Posted: {{ $job->created_at->format('F j, Y \a\t g:i A') }}</div>
        <div class="mb-4">
    ...
    <div class="space-x-4">
        <a href="{{ route('employers.show', $job->employer) }}" class="text-blue-600 underline mt-4 inline-block">All
            jobs by {{ $job->employer->name }}</a>
        @can('edit', $job)
